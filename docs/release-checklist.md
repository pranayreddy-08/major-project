...
- [ ] Backend, ML, frontend, migration, and container GitHub Actions jobs passed for the same SHA.
...
- [ ] `JWT_SECRET`, database password, analyst/admin passwords, issuer, audience, and HTTPS origin are
      set to non-example values.
...
- [ ] Analyst login, overview, alerts, incident timeline, explanation, and attack graph work.
